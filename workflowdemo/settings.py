"""
Django settings for workflowdemo project.
...
SECRET_KEY = 'q2qkf(p@x=5g1z=taj@ix^0cbdkny%ld^ehjzi6q6wfrk129^^'
...
ROOT_URLCONF = 'workflowdemo.urls'
...
WSGI_APPLICATION = 'workflowdemo.wsgi.application'
