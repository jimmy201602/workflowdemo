...
class WorkFlowAPiRequest(object):
    def __init__(self,token=settings.WORKFLOWTOKEN, appname=settings.WORKFLOWAPPNAME, username='admin', workflowbackendurl=settings.WORKFLOWBACKENDURL):
        self.token = token
...
#ins.getdata(parameters=dict(username='admin', per_page=20, name=''),method='get',url='/api/v1.0/workflows')